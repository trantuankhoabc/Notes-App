...
addBtn.addEventListener("click", function(e) {
  ...
  let myObj = {
    title: addTitle.value, text: addTxt.value,
  };
  notesObj.push(myObj);
...
function showNotes() {
  ...
  notesObj.forEach(function(element, index) {
    html += `
      <div class="noteCard my-2 me-4 card" style="width: 18rem;">
        <div class="card-body">
          <h5>
          ...
          <div class="d-flex justify-content-end gap-2">
            <button id="${index}" onclick="deleteNote(this.id)" class="btn btn-danger">
              ...
              <button id="${index}" onclick="editNote(this.id)" class="btn btn-success">
  ...
  function deleteNote(index) {
    ...
    notesObj.findIndex(element => {
      ...
      addTitle.textContent = element.text;
    });
